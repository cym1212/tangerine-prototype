...
-- Post 1
INSERT INTO post (id, title, visit_start_date, visit_end_date, comment_cnt, favorite_cnt, place_block_cnt, visit_region,created_at,member_id,status)
VALUES (1, '테스트 제목 1', '2024-02-03', '2024-02-10', 1, 1, 1, '테스트 지역 1','2024-02-11',1,'PUBLISHED');

-- Post 2
INSERT INTO post (id, title, visit_start_date, visit_end_date, comment_cnt, favorite_cnt, place_block_cnt, visit_region,created_at,member_id,status)
VALUES (2, '테스트 제목 2', '2024-02-10', '2024-02-17', 1, 1, 1,  '테스트 지역 2','2024-02-18',2,'PUBLISHED');

-- Post 3
INSERT INTO post (id, title, visit_start_date, visit_end_date, comment_cnt, favorite_cnt, place_block_cnt, visit_region,created_at,member_id,status)
VALUES (3, '테스트 제목 3', '2024-02-17', '2024-02-24', 1, 1, 1,  '테스트 지역 3','2024-02-25',3,'PUBLISHED');
