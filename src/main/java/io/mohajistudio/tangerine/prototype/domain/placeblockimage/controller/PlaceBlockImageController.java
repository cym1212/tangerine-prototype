...
public class PlaceBlockImageController {
    ...
    @Operation(summary = "스토리지에 이미지 업로드", description = "이미지 값을 넘기면 S3에 이미지를 저장하고 PlaceBlockImage를 반환합니다.")
    public List<PlaceBlockImageDTO.Upload> imagesUpload(@RequestPart(value = "imageFiles", required = false) List<MultipartFile> imageFiles) {
